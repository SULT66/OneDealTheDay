...
if (!app.includes("responseLimit") || !app.includes("catalogRowLimit") || !app.includes("Math.min(1000")) {
...
if (!browserApp.includes("&limit=200")) throw new Error("Homepage still downloads the complete product catalog");
