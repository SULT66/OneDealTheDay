...
const copy = {
  en: {
    ...
    "assistant.short": "AI Shopping",
    "assistant.ask": "Ask AI Shopping Assistant",
    "assistant.askInstead": "Ask AI to search instead",
    "assistant.title": "AI Shopping Assistant",
    "assistant.subtitle": "Compare options, not hype",
    "assistant.intro": "Tell me what you need, your budget and what matters most. I can search OneDailyDrop offers, compare tradeoffs and check current web information.",
  ...
  es: {
    ...
    "assistant.short": "Compras con IA",
    "assistant.ask": "Preguntar al asistente de compras",
    "assistant.askInstead": "Pedir a la IA que busque",
    "assistant.title": "Asistente de compras con IA",
    "assistant.subtitle": "Compara opciones, no publicidad",
    "assistant.intro": "Dime qué necesitas, tu presupuesto y qué es lo más importante. Puedo buscar ofertas, comparar ventajas y verificar información actual.",
  ...
  fr: {
    ...
    "assistant.short": "Shopping IA",
    "assistant.ask": "Demander à l’assistant shopping IA",
    "assistant.askInstead": "Demander à l’IA de chercher",
    "assistant.title": "Assistant shopping IA",
    "assistant.subtitle": "Comparer les options, sans battage",
    "assistant.intro": "Dites-moi ce que vous cherchez, votre budget et vos priorités. Je peux rechercher les offres, comparer les compromis et vérifier les informations actuelles.",
  ...
  de: {
    ...
    "assistant.short": "KI-Shopping",
    "assistant.ask": "KI-Einkaufsassistent fragen",
    "assistant.askInstead": "KI stattdessen suchen lassen",
    "assistant.title": "KI-Einkaufsassistent",
    "assistant.subtitle": "Optionen vergleichen, ohne Hype",
    "assistant.intro": "Sagen Sie mir, was Sie suchen, Ihr Budget und Ihre Prioritäten. Ich kann Angebote durchsuchen, Vor- und Nachteile vergleichen und aktuelle Informationen prüfen.",
