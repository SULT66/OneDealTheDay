(() => {
  ...
  scrollStyle.textContent = `
    ...
    @media(max-width:720px){.scroll-top-button{left:auto!important;right:14px!important;bottom:14px;width:50px;height:50px;border-radius:16px}.scroll-top-button::before{border-radius:13px}}
  `;
